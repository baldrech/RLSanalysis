...
sitesWithGroups$g[is.na(sitesWithGroups$g)] <- 7 # assign other sites a code of 7. NOTE, these codes are just arbitrary to produce better colours in the plot below, this should be improved. 
